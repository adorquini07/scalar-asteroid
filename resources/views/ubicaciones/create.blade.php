        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('ubicaciones.store') }}" class="space-y-5">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="total_mesas" class="block mt-1 w-full" type="number" min="0"
                                name="total_mesas" :value="old('total_mesas', 0)" required placeholder="Ej: 7" />
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Número de mesas habilitadas. Las
                                mesas se generan del 1 al N.</p>
