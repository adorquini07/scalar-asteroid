        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('personas.update', $persona->id) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div
                            ...
                            <label for="activo" class="inline-flex items-center cursor-pointer">
                                <input id="activo" type="checkbox"
                                    ...
                                    name="activo" value="1" {{ old('activo', $persona->activo) ? 'checked' : '' }}>
                                <span
