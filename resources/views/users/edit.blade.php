                        ...
                        <form method="POST" action="{{ route('users.update', $user->id) }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input id="name" type="text" name="name"
                                    ...
                                    value="{{ old('name', $user->name) }}" required autofocus placeholder="Ej: Juan Pérez">
                                @error('name')
                            ...
                            <div class="mb-4">
                                ...
                                <input id="email" type="email" name="email"
                                    ...
                                    value="{{ old('email', $user->email) }}" required placeholder="Ej: usuario@correo.com">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                <label for="password" class="form-label text-secondary small fw-bold text-uppercase">
                                    <i class="bi bi-lock me-1 text-indigo-400"></i>Contraseña
                            ...
                            <div class="mb-4">
                                ...
                                <select id="rol" name="rol"
                                    ...
                                    <option value="registradora" {{ old('rol', $user->rol) === 'registradora' ? 'selected' : '' }}>
                                        Registradora — Solo formularios y listado actual
                                    </option>
                                    <option value="visor" {{ old('rol', $user->rol) === 'visor' ? 'selected' : '' }}>
