                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('users.update', $user->id) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="password" class="block mt-1 w-full placeholder:text-sm" type="password"
                                name="password" autocomplete="new-password" placeholder="Solo si deseas cambiarla..." />
                        ...
                        <div>
                            ...
                            <select id="rol" name="rol"
                                ...
                                <option value="registradora" {{ old('rol', $user->rol) === 'registradora' ? 'selected' : '' }}>Registradora (Solo forms y listado actual)</option>
                                <option value="visor" {{ old('rol', $user->rol) === 'visor' ? 'selected' : '' }}>Visor
                                    (Solo ver ubicaciones)</option>
                            </select>
